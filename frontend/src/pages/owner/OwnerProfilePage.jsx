...
export default function OwnerProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Profile" subtitle="Owner and super admin account details.">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-outline-variant/15 bg-surface-container-lowest p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-on-surface-variant">This profile page is used for identity review and sign out only.</p>
            </div>
